...
\begin{titlepage}
    \begin{center}
        ...
        \Huge
        \textbf{NUMERIČKA APROKSIMACIJA} \\
        \Large
        \textit{Razvoj web aplikacije za metodu najmanjih kvadrata}
...
\begin{itemize}
    \item \textbf{Next.js 14 (React Framework):} Omogućava nam kreiranje brzih, "server-side rendered" (SSR) ili statičkih web stranica. Iako se naša aplikacija u potpunosti izvršava na klijentu (SPA - Single Page Application), Next.js pruža odličnu strukturu projekta i routing.
...
### Algoritam linearne aproksimacije
...
Aplikacija koristi tzv. "Split-screen" raspored. Lijeva strana ekrana rezervirana je za unos podataka (tabela) i kontrolu parametara, dok desna strana prikazuje rezultate (graf i tekstualno objašnjenje).
...
\begin{figure}[H]
    ...
    \fbox{\begin{minipage}{12cm}\vspace{6cm}\centering\Large Slika sučelja aplikacije (Input)\end{minipage}}
    \caption{Prikaz komponente za unos tačaka}
\end{figure}
...
\begin{figure}[H]
    \centering
    % Placeholder for screenshot
    \fbox{\begin{minipage}{10cm}\vspace{5cm}\centering\Large Graf linearne regresije\end{minipage}}
...
\bibitem{knjiga_mn}
I. Prezime, \textit{Numerička Matematika: Algoritmi i Primjena}, Akademska Knjiga, Sarajevo, 2018.

\bibitem{chapra}
S. C. Chapra, R. P. Canale, \textit{Numerical Methods for Engineers}, 7th Edition, McGraw-Hill Education, 2015.

\bibitem{predavanja}
A. Karač, \textit{Predavanja iz predmeta Primijenjene numeričke metode u softverskom inženjerstvu}, Politehnički fakultet, Univerzitet u Zenici, 2026.

\bibitem{nextjs_docs}
Vercel Inc., \textit{Next.js Documentation}, dostupno online na: \url{https://nextjs.org}, pristupljeno: Februar 2026.

\bibitem{plotly}
Plotly Technologies Inc., \textit{Collaborative data science}, dostupno online na: \url{https://plot.ly}, pristupljeno: Februar 2026.
